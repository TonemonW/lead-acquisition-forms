...
interface IContactInformationStepProps {
    onBack: () => void;
    onSubmit: (data: LoanFormData) => void;
    isSubmitted?: boolean;
}

export const ContactInformationStep = ({ onBack, onSubmit, isSubmitted = false }: IContactInformationStepProps) => {
    const { register, formState: { errors } } = useFormContext<LoanFormData>();
    const { handleSubmit, handleFormSubmit, handleInvalid, handlePhoneInput, handlePhonePaste, submitError, isSubmitting, disabled } =
        useContactForm(onSubmit, isSubmitted);
    ...
    return (
        <div className="animate-in fade-in slide-in-from-left-4 duration-500">
            ...
            <form onSubmit={handleSubmit(handleFormSubmit, handleInvalid)} className="space-y-3" noValidate>
                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            {...register('phoneNumber', { onChange: handlePhoneInput })}
                            id="phoneNumber"
                            inputMode="numeric"
                ...
                <div className="flex space-x-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400">
                    ...
                    <Button
                        ...
                        className={`flex-1 ${isSubmitted
                            ? 'bg-none bg-green-500 text-white'
                            : isSubmitting
